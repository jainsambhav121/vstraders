              ...
              <CardContent className="space-y-6">
                ...
                <FormField control={form.control} name="content" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Textarea placeholder="Write your blog post here..." className="min-h-[300px]" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              </CardContent>
              ...
              <CardContent className="space-y-6">
                <FormField control={form.control} name="seoTitle" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="A catchy title for search results" {...field} /></FormControl>
                ...
                <FormField control={form.control} name="seoMetaDescription" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Textarea placeholder="A concise description for search snippets" {...field} /></FormControl>
              ...
              <CardContent className="space-y-6">
                ...
                <FormField control={form.control} name="imageAlt" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="A descriptive caption for the image" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
